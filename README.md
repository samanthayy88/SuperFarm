...
| **Schedule** | Daily work plan filterable by worker, farm, plot and date range, in calendar / by-worker / list views. Several tasks can be entered at once — rows appear as you type — and each is scheduled across the repeat period |
