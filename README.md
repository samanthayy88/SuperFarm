...
| **Schedule** | Daily work plan filterable by worker, farm, plot and date range, in calendar / by-worker / list views. Several tasks and several plots can be entered at once — task rows appear as you type — and each combination is scheduled across the repeat period. Created tasks can be edited or deleted, and their status cycled by clicking the badge |
