...
export const seedDB: DB = {
  ...
  plots: [
    ...
    // Also carries one archived cycle, to seed the "History" view with an example.
      ...
      history: [
        {
          id: "cyc1",
          cropId: "c2",
          variety: "Long Bean 101",
          workerId: "w3",
          cycle: { sowing: "2025-12-01", planting: "2025-12-20", flowering: "2026-02-02", harvesting: "2026-03-10", fallow: "2026-04-10" },
  ...
  workers: [
    { id: "w1", name: "Worker A (demo)", idNumber: "DEMO-0001", dob: "1992-04-11", phone: "000-000 0001", nationality: "Myanmar", joinDate: "2025-02-01", baseSalary: 1700, farmId: "f1", active: true },
    { id: "w2", name: "Worker B (demo)", idNumber: "DEMO-0002", dob: "1989-11-02", phone: "000-000 0002", nationality: "Myanmar", joinDate: "2025-03-15", baseSalary: 1700, farmId: "f1", active: true },
    { id: "w3", name: "Worker C (demo)", idNumber: "DEMO-0003", dob: "1995-07-23", phone: "000-000 0003", nationality: "Bangladesh", joinDate: "2025-06-01", baseSalary: 1800, farmId: "f1", active: true },
    { id: "w4", name: "Worker D (demo)", idNumber: "DEMO-0004", dob: "1990-01-30", phone: "000-000 0004", nationality: "Indonesia", joinDate: "2025-08-10", baseSalary: 1750, farmId: "f2", active: true },
    { id: "w5", name: "Worker E (demo)", idNumber: "DEMO-0005", dob: "1993-09-14", phone: "000-000 0005", nationality: "Indonesia", joinDate: "2026-01-05", baseSalary: 1700, farmId: "f2", active: true },
  ],

  commissionSettings: [
    // Worker A earns a bit above Chili's global rate (RM0.30/kg) on their own plot.
    { id: "cs1", workerId: "w1", farmId: "f1", plotId: "p1", cropId: "c1", variety: "Kulai Red", ratePerKg: 0.35 },
    // Worker D on cucumber, any variety — above the global RM0.12/kg rate.
    { id: "cs2", workerId: "w4", farmId: "f2", plotId: "p4", cropId: "c3", ratePerKg: 0.15 },
  ],

  harvestTargets: [
    { id: "ht1", workerId: "w1", startDate: "2026-07-01", endDate: "2026-07-31", farmId: "f1", plotId: "p1", cropId: "c1", variety: "Kulai Red", targetKg: 2200 },
    { id: "ht2", workerId: "w2", startDate: "2026-07-01", endDate: "2026-07-31", farmId: "f1", plotId: "p2", cropId: "c2", variety: "Long Bean 101", targetKg: 2400 },
    { id: "ht3", workerId: "w3", startDate: "2026-07-01", endDate: "2026-07-31", farmId: "f1", plotId: "p3", cropId: "c1", variety: "Bara F1", targetKg: 1800 },
    { id: "ht4", workerId: "w4", startDate: "2026-07-01", endDate: "2026-07-31", farmId: "f2", plotId: "p4", cropId: "c3", variety: "Green Star", targetKg: 3200 },
    { id: "ht5", workerId: "w5", startDate: "2026-07-01", endDate: "2026-07-31", farmId: "f2", plotId: "p5", cropId: "c4", variety: "Clemson Spineless", targetKg: 1100 },
  ],
  ...
  harvests: [
    ...
    { id: "h1", date: "2026-07-02", plotId: "p1", workerId: "w1", cropId: "c1", variety: "Kulai Red", quantityKg: 420 },
    { id: "h2", date: "2026-07-09", plotId: "p1", workerId: "w1", cropId: "c1", variety: "Kulai Red", quantityKg: 465 },
    { id: "h3", date: "2026-07-16", plotId: "p1", workerId: "w1", cropId: "c1", variety: "Kulai Red", quantityKg: 510 },
    { id: "h4", date: "2026-07-23", plotId: "p1", workerId: "w1", cropId: "c1", variety: "Kulai Red", quantityKg: 480 },
    { id: "h5", date: "2026-07-30", plotId: "p1", workerId: "w1", cropId: "c1", variety: "Kulai Red", quantityKg: 445 },
    { id: "h6", date: "2026-07-04", plotId: "p2", workerId: "w2", cropId: "c2", variety: "Long Bean 101", quantityKg: 610 },
    { id: "h7", date: "2026-07-11", plotId: "p2", workerId: "w2", cropId: "c2", variety: "Long Bean 101", quantityKg: 655 },
    { id: "h8", date: "2026-07-18", plotId: "p2", workerId: "w2", cropId: "c2", variety: "Long Bean 101", quantityKg: 590 },
    { id: "h9", date: "2026-07-25", plotId: "p2", workerId: "w2", cropId: "c2", variety: "Long Bean 101", quantityKg: 630 },
    { id: "h10", date: "2026-07-08", plotId: "p3", workerId: "w3", cropId: "c1", variety: "Bara F1", quantityKg: 380 },
    { id: "h11", date: "2026-07-15", plotId: "p3", workerId: "w3", cropId: "c1", variety: "Bara F1", quantityKg: 410 },
    { id: "h12", date: "2026-07-22", plotId: "p3", workerId: "w3", cropId: "c1", variety: "Bara F1", quantityKg: 435 },
    { id: "h13", date: "2026-07-29", plotId: "p3", workerId: "w3", cropId: "c1", variety: "Bara F1", quantityKg: 460 },
    { id: "h14", date: "2026-07-06", plotId: "p4", workerId: "w4", cropId: "c3", variety: "Green Star", quantityKg: 820 },
    { id: "h15", date: "2026-07-13", plotId: "p4", workerId: "w4", cropId: "c3", variety: "Green Star", quantityKg: 880 },
    { id: "h16", date: "2026-07-20", plotId: "p4", workerId: "w4", cropId: "c3", variety: "Green Star", quantityKg: 790 },
    { id: "h17", date: "2026-07-27", plotId: "p4", workerId: "w4", cropId: "c3", variety: "Green Star", quantityKg: 850 },
    { id: "h18", date: "2026-07-10", plotId: "p5", workerId: "w5", cropId: "c4", variety: "Clemson Spineless", quantityKg: 310 },
    { id: "h19", date: "2026-07-17", plotId: "p5", workerId: "w5", cropId: "c4", variety: "Clemson Spineless", quantityKg: 340 },
    { id: "h20", date: "2026-07-24", plotId: "p5", workerId: "w5", cropId: "c4", variety: "Clemson Spineless", quantityKg: 365 },
    // June 2026
    { id: "h21", date: "2026-06-05", plotId: "p1", workerId: "w1", cropId: "c1", variety: "Kulai Red", quantityKg: 390 },
    { id: "h22", date: "2026-06-12", plotId: "p1", workerId: "w1", cropId: "c1", variety: "Kulai Red", quantityKg: 405 },
    { id: "h23", date: "2026-06-19", plotId: "p1", workerId: "w1", cropId: "c1", variety: "Kulai Red", quantityKg: 430 },
    { id: "h24", date: "2026-06-26", plotId: "p1", workerId: "w1", cropId: "c1", variety: "Kulai Red", quantityKg: 415 },
    { id: "h25", date: "2026-06-06", plotId: "p2", workerId: "w2", cropId: "c2", variety: "Long Bean 101", quantityKg: 560 },
    { id: "h26", date: "2026-06-13", plotId: "p2", workerId: "w2", cropId: "c2", variety: "Long Bean 101", quantityKg: 585 },
    { id: "h27", date: "2026-06-20", plotId: "p2", workerId: "w2", cropId: "c2", variety: "Long Bean 101", quantityKg: 605 },
    { id: "h28", date: "2026-06-27", plotId: "p2", workerId: "w2", cropId: "c2", variety: "Long Bean 101", quantityKg: 575 },
    { id: "h29", date: "2026-06-10", plotId: "p4", workerId: "w4", cropId: "c3", variety: "Green Star", quantityKg: 760 },
    { id: "h30", date: "2026-06-17", plotId: "p4", workerId: "w4", cropId: "c3", variety: "Green Star", quantityKg: 800 },
    { id: "h31", date: "2026-06-24", plotId: "p4", workerId: "w4", cropId: "c3", variety: "Green Star", quantityKg: 785 },
  ],
